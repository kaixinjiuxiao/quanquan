...
public class HuiDaDetailsOneActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgBack:
                ...
                break;
            case R.id.txtRight:
                Intent intent = new Intent(HuiDaDetailsOneActivity.this, EvaluateActivity.class);
